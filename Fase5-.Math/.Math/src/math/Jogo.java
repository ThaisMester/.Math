...
public abstract class Jogo {
    ...
    public int verificaAmbiguidade(int X,int Y,int OP,int resPlayer) {
        if(((OP==3)&&(X==0))||((OP==3)&&(Y==1)))
            ...
            if(((OP==4)&&(X==0))||((OP==4)&&(Y==1)))
                ...
                if(((OP==1)&&(Y==0))&&((resPlayer==1)||(resPlayer==2)))
                    return OP;
                else
                    if(((OP==2)&&(Y==0))&&((resPlayer==1)||(resPlayer==2)))
                        return OP;
                    else
                        if((((OP==1)||(OP==3))&&((X==2)&&(Y==2)))&&((resPlayer==1)||(resPlayer==3)))
                                return OP;
                            else
                                if((((OP==2)||(OP==4))&&((X==4)&&(Y==2)))&&((resPlayer==2)||(resPlayer==4)))
                                    return OP;
                                else
                                    if(((X==0)&&(Y==0))&&((resPlayer==1)||(resPlayer==2)||(resPlayer==3)))
                                        return OP;
                        return resPlayer;
    }
